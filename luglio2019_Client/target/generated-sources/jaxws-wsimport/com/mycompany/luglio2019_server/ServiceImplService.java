 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://luglio2019_server.mycompany.com/", wsdlLocation = "http://localhost:8080/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://luglio2019_server.mycompany.com/", "ServiceImplService");
    ...
    public com.mycompany.luglio2019_server.Service getServiceImplPort() {
        return super.getPort(new QName("http://luglio2019_server.mycompany.com/", "ServiceImplPort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServiceImplPort")
    public com.mycompany.luglio2019_server.Service getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://luglio2019_server.mycompany.com/", "ServiceImplPort"), Service.class, features);
    }
